...
%><jsp:forward page="/monitoring-case"/>
<%}%>
...
<div class="sticky top-4 z-10 w-64 bg-white p-4 rounded-lg w-[20rem]">
    ...
    <div class="md:mt-5 p-2 flex justify-around md:block">
        ...
        <a class="flex p-4 items-center rounded-md my-1 text-[#59656F] justify-center lg:justify-start cursor-pointer hover:font-bold ease-in duration-100" href="decision_case.jsp">
    ...
    <div class="modal-content">
        ...
        <form id="editForm" class="flex flex-col gap-4">
            ...
            <div class="flex items-center my-[1.5rem] w-[90%]">
                ...
                <select name="programerCode"  id="programerCode" class="flex-1 p-2 border border-slate-200 rounded" required>
            ...
            <div class="flex items-center my-[1.5rem] w-[90%]">
                ...
                <select name="testerCode" id="testerCode"  class="flex-1 p-2 border border-slate-200 rounded" required>
...
<script>
    ...
    function openEditModal(casoId, argumentos, programerCode, testerCode) {
        document.getElementById("casoId").value = casoId;
        document.getElementById("argumentos").value = argumentos;
        document.getElementById("programerCode").value = programerCode;
        document.getElementById("testerCode").value = testerCode;
    ...
    function saveUpdate() {
        ...
        let programerCode = document.getElementById("programerCode").value;
        let testerCode = document.getElementById("testerCode").value;


        let form = document.createElement("form");
        form.method = "post";
        form.action = "/monitoring_case";
        ...
        programerInput.name = "programerCode";
        programerInput.value = programerCode;
        form.appendChild(programerInput);

        let testerInput = document.createElement("input");
        testerInput.type = "hidden";
        testerInput.name = "testerCode";
        testerInput.value = testerCode;
